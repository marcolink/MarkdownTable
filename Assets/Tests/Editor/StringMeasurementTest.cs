...
namespace StringTable
{
    ...
    {
        private BaseLayoutStrategy measurement;

        [SetUp]
        public void SetUp()
        {
            measurement = new BaseLayoutStrategy();
        }
        ...
        public void Measure_MaxColumnWidth_WidthHeaderAndRows()
        {
            ...
            Assert.AreEqual(11, measurement.ColumnWidth(0));
            Assert.AreEqual(8, measurement.ColumnWidth(1));
            Assert.AreEqual(12, measurement.ColumnWidth(1, 2));
            Assert.AreEqual(17, measurement.ColumnWidth(3));
        }
        ...
        public void Measure_MaxColumnWidth_WidthHeaderAndRows2()
        {
            ...
            measurement.AddRow("one and one", "two", "three", "four", "six");
            measurement.AddRow("", "two", "three", "four on the floor", "six");
            Assert.AreEqual(16, measurement.ColumnWidth(0));
            Assert.AreEqual(8, measurement.ColumnWidth(1));
            Assert.AreEqual(12, measurement.ColumnWidth(1, 2));
            Assert.AreEqual(17, measurement.ColumnWidth(3));
        }
        ...
        public void Measure_MaxColumns()
        {
            ...
            Assert.AreEqual(7, measurement.MaxColumns());
        }
    }
}
